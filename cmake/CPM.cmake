function(CPM_GIT SYMBOL GIT_REPO GIT_TAG PREFIX)
    ...
    if (${SYMBOL}_IMPORTED)
        ...
        add_subdirectory(${${SYMBOL}_IMPORTED_PREFIX}/${SYMBOL})
        set(${SYMBOL}_DIR ${${SYMBOL}_IMPORTED_PREFIX}/${SYMBOL} CACHE INTERNAL "${SYMBOL}_DIR_IMPORTED")
    else ()
        ...
        set(${SYMBOL}_DIR ${PREFIX}/${SYMBOL} CACHE INTERNAL "${SYMBOL}_DIR_IMPORTED")
    endif ()
endfunction(CPM_GIT)